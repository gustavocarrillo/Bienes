                    ...
                    <div class="row clearfix">
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-line">
                                    <input type="text" name="resolucion" class="form-control" value="{{ $departamento->resolucion  }}" maxlength="10">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="direccion" class="form-control">
                                    ...
                                    @foreach($direcciones as $direccion)
                                        <option value="{{ $direccion->id }}" @if($departamento->direccion == $direccion->id) selected @endif>{{ $direccion->codigo.' - '.$direccion->descripcion }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
